...
class P0ShardsTest(unittest.TestCase):
    def test_build_manifest_maps_current_smoke_shards_and_keeps_paper_false(self):
        ...
        self.assertEqual(8, len(manifest["missing_memory_policy_shards"]))
        self.assertIn(
        ...
        self.assertEqual(
            ...
            shards[("VisA", "PatchCore")]["missing_memory_policies"],
        )
        self.assertEqual(
            72,
    ...
    def test_plan_command_writes_manifest(self):
        with tempfile.TemporaryDirectory() as tmpdir:
            ...
            self.assertEqual(8, len(payload["missing_memory_policy_shards"]))
