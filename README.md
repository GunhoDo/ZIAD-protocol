...
WinCLIP validation steps for MVTec/VisA × `none`/`temperature_scaling`; do not
run the full 24-step plan.
...
results. After these runs, full-P0 dry-run reports `skipped=4` and `pending=20`.
